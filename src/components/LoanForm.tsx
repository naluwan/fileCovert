  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="text-2xl font-bold text-center mb-6">借貨單生成器</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
              <Label htmlFor="departmentName">部門名稱</Label>
              <Input
                id="departmentName"
            ...
            <div>
              <Label htmlFor="stampDate">借貨專用章日期</Label>
              <Input
                id="stampDate"
                type="date"
            ...
            <div>
              <Label htmlFor="storeNo">店號</Label>
              <Input
                id="storeNo"
            ...
            <div>
              <Label htmlFor="deliveryNote">到店備註</Label>
              <Input
                id="deliveryNote"
            ...
            <div>
              <Label htmlFor="specialist">專員</Label>
              <Input
                id="specialist"
            ...
            <div>
              <Label htmlFor="returnDate">預計訂還日期</Label>
              <Input
                id="returnDate"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold mb-4">預覽</h2>
